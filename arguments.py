...
def get_args():
    ...
    parser.add_argument('--alg', type=str, default='res', choices=['normal', 'vgg', 'res'])
    ...
    #Our ARGS
    parser.add_argument('--epoch_limit',type=int,default=200)
    parser.add_argument('--precision_point', type=int, default=2)
