...
#################################################################
# RUN JOBS ON ALL MODELS AND KERNELS USING THE CIFAR100 DATASET #
#################################################################
...
do
    ...
    do
        ...
        do
            ...
            # Run an experiment with the Cifar100 dataset
            ...
            git add ./logs/*
            git add ./output/*
            git commit -m "$(date +'%F %T'): $model | cifar100 | $distribution (Type $kernel_type)"
