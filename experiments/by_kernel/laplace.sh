...
################################################################
# RUN JOBS ON ALL MODELS AND DATASETS USING THE LAPLACE KERNEL #
################################################################
...
do
    ...
    do 
        ...
        do
            ...
            # Run an experiment with the Laplace kernel
            ...
            git add ./logs/*
            git add ./output/*
            git commit -m "$(date +'%F %T'): $model | $dataset | laplace (Type $kernel_type)"
