...
if __name__ == '__main__':
    ...
    output_dir = f"{ARGS.output_path}/{ARGS.distribution}/{ARGS.kernel_type}/{ARGS.model}/{ARGS.dataset}/{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}"
    ...
    for epoch in range(1, ARGS.epochs + 1):
        ...
        if not ARGS.no_kernel: model.update_kernels(epoch)
    ...
    # VALIDATION ==================================================================================
        ...
        LOGGER.info(f"EPOCH: {epoch:>3} | ACCURACY: {accs[-1]} | LOSS: {losses[-1]}")
