...
'''
#ResNet CBS std Unbound Mean Unbound
...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.planes = planes
        #Std and Mean Initialize with constant 1 but changes with first epoch
        self.std2 = 1
        self.std3 = 1
        self.mean2 = 1
        self.mean3 = 1
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, args):
        ...
        self.kernelType = args.kernel_type
        ...
        CSVFile = "ResNet18_CBS_"+ self.dataset+"_Precision_Point_" + precision_point + "_kernel_Type_" + str(self.kernelType)  + ".csv"
        self.cfile = directory + CSVFile
        current_working_dir = os.getcwd()
        filename = os.path.join(current_working_dir, self.cfile)
        print(filename)
        header = ['Data_Std', 'ResNet18_CBS_Layer_1_Std', 'ResNet18_CBS_Layer_5_Std', 'ResNet18_CBS_Layer_9_Std', 'ResNet18_CBS_Layer_13_Std',
                  'ResNet18_CBS_Layer_18_Std', 'Data_Mean', 'ResNet18_CBS_Layer_1_Mean', 'ResNet18_CBS_Layer_5_Mean', 'ResNet18_CBS_Layer_9_Mean',
                  'ResNet18_CBS_Layer_13_Mean', 'ResNet18_CBS_Layer_18_Mean','ResNet18_CBS_Std']
    ...
    def get_new_kernels(self, epoch_count):
        #if epoch_count % self.epoch == 0 and epoch_count is not 0:  #CBS changes of std at 5 epoch (default value)
            #print("Self Epoch: " + str(self.epoch))
            #self.std0 *= self.factor
        ...
        for child in self.layer1.children():
            child.get_new_kernels(epoch_count)
