...
# Define file handler
file_handler = logging.FileHandler(f"{ARGS.logger_path}/{ARGS.model}/{ARGS.distribution}{f'/{ARGS.kernel_type}' if ARGS.distribution else ''}/{ARGS.dataset}/{datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S')}.log")
